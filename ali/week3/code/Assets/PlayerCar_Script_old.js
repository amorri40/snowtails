...
function Update () {
	...
	//rigidbody.drag = 0;//rigidbody.velocity.magnitude / 250;
...
FrontRightWheel.motorTorque =  Speed ;
	...
	// multiplied by the user input variable.
	 if ((Input.GetKey ("right")) || Input.GetKey (KeyCode.JoystickButton3)) {
		...
		FrontLeftWheel.motorTorque =  600 ;//EngineTorque / GearRatio[CurrentGear] * 2;//Input.GetAxis("Vertical");
	}
	else
	{
    ...
    if ((Input.GetKey ("left")) || Input.GetKey (KeyCode.JoystickButton2)) {
		...
		FrontRightWheel.motorTorque = 600 ;//EngineTorque / GearRatio[CurrentGear] * 2;//Input.GetAxis("Vertical");
    }
	else
	{
	...
	//FrontRightWheel.brakeTorque =290;
	//FrontLeftWheel.brakeTorque = 290;
